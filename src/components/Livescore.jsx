...
const LiveScoreCard = ({ match, isLive, onClick }) => {
  return (
    <div
      onClick={onClick}
      className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 border border-gray-700 hover:border-[#00a79d] transition-all duration-300 hover:shadow-lg hover:shadow-[#00a79d]/20 cursor-pointer transform hover:scale-105"
    >
      {isLive && (
      ...
      <div className="grid grid-cols-3 gap-4 items-center mb-6">
        ...
        <div className="text-center">
          <p className="text-gray-400 text-xs uppercase">vs</p>
          <div className="my-2">
            <p className="text-gray-300 text-xs">{match.venue}</p>
          </div>
        </div>
        <div className="text-center">
      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6">
        ...
        <div className="mb-12 flex justify-between items-start">
          ...
          {isAuthenticated && (
            <button
              ...
              className="bg-gradient-to-r from-[#00a79d] to-[#008b7f] hover:from-[#008b7f] hover:to-[#006b61] text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 whitespace-nowrap"
            >
              + Create Match
            </button>
          )}
        ...
        {loading ? (
          ...
          <>
            ...
            {matches.length > 0 && (
              <div>
                <h2 className="text-3xl font-bold text-white mb-8">Finished Matches</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {matches.map((match) => (
                    <LiveScoreCard
                      key={match.id}
